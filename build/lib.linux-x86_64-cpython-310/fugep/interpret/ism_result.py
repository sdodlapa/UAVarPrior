...
class ISMResult(object):
    ...
    def __init__(self, data_frame, sequence_type=Genome):
        """
        Constructs a new `fugep.interpret.ISMResult` object.
    ...
    def sequence_type(self):
        ...
        subclass of `fugep.sequences.Sequence`.
    ...
    def from_file(input_path, sequence_type=Genome):
        """
        Loads a `fugep.interpret.ISMResult` from a `pandas.DataFrame`
